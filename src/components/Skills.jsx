  ...
  return (
    <div className="skillss" id="skills">
      ...
      className="skills_container">
        ...
        <Card className="skills_card">
          <img className="skills_img" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg" alt=""/>
          <h2 className="skills_text">ExpressJs</h2>
        </Card>
        ...
        <Card className="skills_card">
          <img className="skills_img" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" alt=""/>
          <h2 className="skills_text">Bootstrap</h2>
        </Card>
